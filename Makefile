...
all: CsvToTsv.exe TxtToTsv.exe nut.exe digest.exe ingred.dat barf.txt \
     lookup.exe usda_foods.tsv usda_portions.tsv food.txt
...
scour: clean
	...
	tjg.txt CsvToTsv.exe TxtToTsv.exe
